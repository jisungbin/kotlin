...
class KotlinLibraryResolverImpl<L : KotlinLibrary> internal constructor(
    ...
    override fun resolveWithoutDependencies(
        ...
        disallowDuplicatedUniqueNames: Boolean,
    ) = findLibraries(unresolvedLibraries, noStdLib, noDefaultLibs, noEndorsedLibs)
        .leaveDistinct()
        .omitDuplicateNames(disallowDuplicatedUniqueNames)
     ...
     */
    private fun List<KotlinLibrary>.omitDuplicateNames(disallowDuplicatedUniqueNames: Boolean) : List<KotlinLibrary> {
        ...
        return if (disallowDuplicatedUniqueNames) {
            deduplicatedLibs
        } else {
            this
        }
