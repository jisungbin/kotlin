...
object FirErrors {
    ...
    val VALUE_DATAARGS_CONFLICT: KtDiagnosticFactory0 = KtDiagnosticFactory0("VALUE_DATAARGS_CONFLICT", ERROR, SourceElementPositioningStrategies.NAME_OF_NAMED_ARGUMENT, KtValueArgument::class)
    val SEALEDARGS_NO_CONSTRUCTOR: KtDiagnosticFactory0 = KtDiagnosticFactory0("SEALEDARGS_NO_CONSTRUCTOR", ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class)
